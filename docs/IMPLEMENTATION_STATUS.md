...
| A06 XDG adapters + multi-instance/locking behavior | `infrastructure/profile.rs`, `infrastructure/linux/{xdg,instance}.rs`, ADR-007, migration recovery-layout refactor, real-binary UTS instance probe | **implemented at source/test level; host Cargo + real-binary instance probe verification pending** | A07 |
